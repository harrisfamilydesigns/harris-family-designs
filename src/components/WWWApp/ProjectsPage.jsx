...
const projects = [
  ...
  {name: 'Budget Tracker', status: 'in_progress', description: 'Set up your weekly safe-to-spend and track transactions.', path: 'budget_tracker'},
  ...
  {name: 'GolfShot', status: 'in_progress', description: 'Hit the perfect golf shot, every time.', path: '/golf_shot'}
]
